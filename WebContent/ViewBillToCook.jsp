...
.has-bg-img:after {
    content:'';
    background: url('./resources/images/lastlast.jpeg') no-repeat center center fixed;
    position: absolute;
    top:0px;
    left: 0px;
   -webkit-background-size: cover;
		...
		<div id="templatemo_content">
			...
			<div id="templatemo_content_right">
				<form action="ViewBillToCook.jsp" method="post">
									<h1  style="font-family:Mistral;color:WHITE; font-size:100px;margin-top:-30px;margin-left:-750px;"><u>View Bills</u></h1>
					...
					<table width="100%"
						...
						<tr>
							<td>TableNo</td>
							<td><br/><br/><select name="tableNo" style="width:100px;margin-bottom:20px;margin-left:10px;">
							...
							<input class="button button1" type="submit" style="margin-top:30px;margin-left:-700px;"/>
				</form>
				<%
				...
				%>
					...
					<form action="cook?action=clear" method="post">
						<table width="100%" style="margin-top: -30px; margin-left: 300px; font-size: 35px;color:white;font-family:Lucida Calligraphy;">
							<%
						...
						<input class="button button1" type="submit" value="clear" name="cl" style="margin-left:150px;margin-top:-10px;"/>
					</form>
							
							
						
				<table
					style="width: 90%; margin: 20px; padding: 20px; border-style: solid">
					<%
					...
					%>
					<tr> table NO:<%=request.getParameter("tableNo")%>
						<td><%=i + 1%></td>
				...
				%>
				<p style="color:white;margin-left:-350px;margin-top:30px;font-size:25px;font-family:Lucida Calligraphy;">There are no Bill Details available for this table No</p>
			<p style="color:white; font-size:30px;">	<%=request.getParameter("tableNo")%> </p>
				<%
					}
				%>
