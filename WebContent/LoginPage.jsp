...
<h1 style="font-family:Lucida Calligraphy;color:#c79559; font-size:80px;margin-top:190px;margin-left:150px;"><u>Login</u></h1>
		...
		<div id="templatemo_content_left"
			...
			<form action="control?action=login" method="post">
				<div><table
					...
					%>
					<tr>
						<td style="margin-left:200px;color:#c79559;font-size:30px; font-family: Lucida Calligraphy;margin-top:10px;">Table</td>
						<td><input type="text" name="userName" id="userName" style="height:25px; width:300px; margin-left:80px; " /></td>
					</tr></table></div>
					<div>
					<table
					style="width: 40%; margin: 30px; padding: 30px; margin-left:450px; color:black; font-weight:bold;">
					<tr>
						<td style="margin-left:450px;color:#c79559;font-size:30px; font-family: Lucida Calligraphy;margin-top:10px;">Password</td>
						<td><input type="password" name="pass" id="pass" style="height:25px; width:300px;" /></td>
					</tr></table></div>
					<div>
					<table
					style="width: 40%; margin: 30px; padding: 30px; margin-left: 280px; margin-top:10px; color:black; font-weight:bold;">
					<tr>
						<td  align="center"><input class="button button1" type="submit"
							value="Login" style="margin-top:-150px;margin-left:270px;font-weight:bold;" /> <input class="button button2" type="reset" style="margin-top:-60px;margin-left:550px;font-weight:bold;"  /></td>
					</tr>
				</table></div>
			</form>
			<!-- end of content left -->
