...
.has-bg-img:after {
    content:'';
    background: url('./resources/images/c4.jpg') no-repeat center center fixed;
    position: absolute;
    top:0px;
    left: 0px;
   -webkit-background-size: cover;
	...
	<div class="has-bg-img" style="height:900%;">
		...
		<div id="templatemo_content">
			...
			<div id="templatemo_content_right">
					...
					<h1 style="font-family:Mistral;color:WHITE; font-size:100px;margin-top:-30px;margin-left:-100px;">Add Item</h1>
					<form action="cook?action=addItem" method="post">
						<table width="100%" style="margin-left:-150px;margin-top:150px;">
							<%
							...
							%>
							<tr>
								<td width="100%" style="color:white;font-family:Lucida Calligraphy;font-size:30px;"><br/><br/><u>Item</u></td>
								<td><br/><br/><input type="text" name="itemName" size="22" /></td>
							</tr>
							
								
							<tr>
								<td width="100%"  style="color:white;font-family:Lucida Calligraphy;font-size:30px;"><br/><br/><u>Category </u></td>
								<td><br/><br/><select style="size: 30" name="categoryId">
							...
							<tr>
								<td width="100%"  style="color:white;font-family:Lucida Calligraphy;font-size:30px;"><br/><br/><u>Quantity</u> </td>
								<td><br/><br/><input type="number" name="qnt" size="30" /></td>
							</tr>
							<tr>
								<td width="100%"  style="color:white;font-family:Lucida Calligraphy;font-size:30px;"><br/><br/><u>Cost</u></td>
								<td><br/><br/><input type="text" name="cost" size="22" /></td>
							</tr>
							<tr>
								<td colspan="2" width="40%"><br/><br/><input class="button button1" type="submit"
									value="Add" style="margin-left:150px;" /> <input class="button button1" type="reset" /></td>
