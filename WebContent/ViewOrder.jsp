				...
				<div style="width: 100%">
					...
					<%
								if (!GlobalConstants.MESSAGE.equals("")
									...
									out.write("<tr><td colspan='3' align='center' style='color:white;visibility:visible;margin-top:50px;'> "
											+ GlobalConstants.MESSAGE + " </td></tr>");
									GlobalConstants.MESSAGE = "";
								}
							%>
					
					<table width="120%" style="border:1px solid white;margin-top: 130px; margin-left: -350px; font-size: 25px;color:white;font-family:Lucida Calligraphy;">
...
<tr>
<td  style="font-family:Lucida Calligraphy;color:#8989b9; font-size:50px;margin-top:330px;margin-left:-550px;">There are no Orders Available</td>
